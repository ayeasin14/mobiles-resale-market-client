    ...
    return (
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <div>
                    <div className="items-center grid-flow-col">
                        <FaMobileAlt className='text-3xl font-semibold text-primary mb-3' />
                        <p>RESALE Industries Ltd. <br />Providing reliable service since 2021</p>
                    </div>
                    <div className="md:place-self-center md:justify-self-start mt-2">
            ...
            <footer className="footer footer-center p-4 bg-base-200 text-base-content">
                <div>
                    <p>Copyright © 2022 - All right reserved by YEASIN</p>
                </div>
            </footer>
        </div>
    );
